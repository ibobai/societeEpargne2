...
export class TransfertComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.transfertService
      ...
      .subscribe(
        (res: HttpResponse<ITransfert[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTransferts(): void {
    this.eventSubscriber = this.eventManager.subscribe('transfertListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITransfert[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
