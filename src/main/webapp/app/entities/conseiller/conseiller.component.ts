...
export class ConseillerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.conseillerService
      ...
      .subscribe(
        (res: HttpResponse<IConseiller[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInConseillers(): void {
    this.eventSubscriber = this.eventManager.subscribe('conseillerListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IConseiller[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
