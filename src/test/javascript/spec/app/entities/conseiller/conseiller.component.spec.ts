...
import { ConseillerComponent } from 'app/entities/conseiller/conseiller.component';
...
describe('Component Tests', () => {
  describe('Conseiller Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.conseillers && comp.conseillers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
